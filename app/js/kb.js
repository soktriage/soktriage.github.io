...
(function (global) {
  ...
  "rules": [
    ...
    {
      "id": "kohoges_csecsemo_gyanus_szamarkohoges",
      "name": "Csecsemő, erősödő köhögés + elsápadás (gyanús szamárköhögés) → MSTR 4",
      "applies_to": "gyermek",
      "condition_text": "Csecsemőnél kb. 1 hete tartó, erősödő köhögés, ami közben elsápadást okoz — a paraméterek (légzésszám/SpO2/pulzus/hőmérséklet) lehetnek teljesen normálisak, mégis MSTR 4: elkülönítés szükséges, mert szamárköhögés (pertussis) állhat a háttérben.",
      "condition": [
        {
          "mezo": "kohogesJelleg",
          "egyenlo": "erosodo_kohoges_csecsemonel_elsapadassal"
        }
      ],
      "level": 4,
      "source": [
    ...
    {
      "id": "kohoges_elsapadas_keringesi_instabilitas",
      "name": "Köhögés közbeni elsápadás, keringési instabilitás jeleként értékelve → MSTR 2",
      "applies_to": "gyermek",
      "condition_text": "Ha a köhögés közbeni elsápadást a triázs ápoló keringési instabilitás jeleként értékeli (nem csak reflexes elsápadásként) → MSTR 2.",
      "condition": [
        {
          "mezo": "kohogesJelleg",
          "egyenlo": "elsapadas_keringesi_instabilitaskent"
        }
      ],
      "level": 2,
      "source": [
    ...
    {
      "id": "kohoges_cyanotikus",
      "name": "Cyanotikus köhögés közben → MSTR 1",
      "applies_to": "gyermek",
      "condition_text": "Ha a gyermek köhögés közben cyanotikussá válik → tovább súlyosbítandó (MSTR 1, összhangban a súlyos légzési elégtelenség/cyanosis egyéb forrás-kritériumaival, ld. gyermek_02/kritikus_03).",
      "condition": [
        {
          "mezo": "kohogesJelleg",
          "egyenlo": "cyanotikus_kohoges_alatt"
        }
      ],
      "level": 1,
      "source": [
    ...
    },
    {
      ...
      "name": "≥3 objektív SIRS-kritérium → MSTR 2 (bármely panasznál, küllemtől függetlenül)",
      "applies_to": "mind",
      "condition_text": "Láz (>38°C) + tachycardia (HR>90) + tachypnoe (RR>20) — a bevitt vitálparaméterekből objektíven számított 3 pozitív SIRS-kritérium önmagában MSTR 2-t indokol, FÜGGETLENÜL a beteg szubjektív megjelenésétől (a fiatal, kompenzált beteg is 'jól nézhet ki') ÉS FÜGGETLENÜL a vezető panasztól — a poszter az »Elsődleges módosító és meghatározó tényezők« (vitális paraméterek) közt sorolja fel, a nehézlégzés/keringés/GCS mellett, NEM panasz-specifikus (másodlagos) módosítóként.",
      "condition": [
        {
          "mezo": "eletkorEv",
          "min": 16
      ...
      "notes": "Tankönyv o.25 (MSTR 2 kritérium-lista): »Láz (hőmérséklet > 38°C) + szeptikus küllem és tünetek (legalább 3+ SIRS kritérium)«. CTAS COT-2008 'Adults: Temperature/Sepsis' (DIA 11): SIRS = temp>38/<36, HR>90, RR>20 (vagy PaCO2<32), WBC-eltérés — »Looks septic: has 3 positive SIRS criteria« → MSTR 2, FÜGGETLENÜL a küllemtől. Kollégák pilot-tesztje találta: HR135+RR22+T39.5 esetén a rendszer MSTR 4-et adott (csak a szubjektív 'jó általános állapot' küllem-választás alapján) — objektív kereszt-ellenőrzés hiányzott. WBC nem elérhető triázskor, ezért csak a 3 elérhető kritérium (láz, HR, RR) alapján számolunk — ez pontosan megfelel a forrás 'legalább 3+ SIRS kritérium' megfogalmazásának. KORHATÁR (MSOTKE-MSTR poszter): kor ≥16 év, ld. korábbi jegyzet. HATÓKÖR-JAVÍTÁS (2026-07-21, Ádám észrevétele): a szabály tévesen csak a 'laz' panaszra volt korlátozva (csakPanaszok:['laz']) — a hivatalos poszteren viszont a SIRS-kritérium az ELSŐDLEGES (nem panasz-specifikus) módosítók táblájában szerepel, a nehézlégzés/keringés/GCS mellett — tehát BÁRMELY vezető panasznál érvényesnek kell lennie (pl. hasi fájdalom + objektíven SIRS-pozitív vitálok is MSTR 2-t indokol). A csakPanaszok-korlátozás törölve, most globális elsődleges módosítóként viselkedik, konzisztensen az elsodleges_felnott_15-18 (szubjektív küllem-alapú) testvér-szabályokkal, amik szintén mindig is globálisak voltak.",
      "conflicts": [],
      "group": "secondary"
    },
    {
    ...
    {
      "id": "esc_laz_padlo_felnott",
      "name": "Láz felnőttnél (>38 °C) → legalább MSTR 4, küllemtől függetlenül",
      "applies_to": "mind",
      "condition_text": "16 év felett, mért testhőmérséklet >38,0 °C — a láz-létra legenyhébb kimenete (jó általános állapot) MSTR 4.",
      "condition": [
        {
          "mezo": "eletkorEv",
          "min": 16
    ...
    {
      "id": "esc_laz_padlo_gyermek_3ho_3ev",
      "name": "Láz 3 hó–3 év (>38,5 °C) → legalább MSTR 3, küllemtől függetlenül",
      "applies_to": "gyermek",
      "condition_text": "3 hónap–3 év, testhőmérséklet >38,5 °C — a gyermek láz-létra legenyhébb kimenete (nem tűnik betegnek) MSTR 3.",
      "condition": [
        {
          "mezo": "eletkorHonap",
          "min": 3,
    ...
    {
      "id": "esc_laz_padlo_gyermek_3ev_felett",
      "name": "Láz 3 év felett (>38,5 °C) → legalább MSTR 4, küllemtől függetlenül",
      "applies_to": "gyermek",
      "condition_text": "3 év felett, testhőmérséklet >38,5 °C — a gyermek láz-létra legenyhébb kimenete (nem tűnik betegnek) MSTR 4.",
      "condition": [
        {
          "mezo": "eletkorHonap",
          "min": 36
  ...
  "vitalBands": [
    {
      ...
      "mervadoMaxHonap": 192,
      "mervadoMegjegyzes": "ÉRTELMEZÉS, NEM SZÓ SZERINTI ELŐÍRÁS — és ezt fontos tudni. A forrás azt mondja ki, hogy „a gyermekgyógyászati irányelveket úgy fejlesztették, hogy 16 éves korig alkalmazhatók” (jegyzet 191. o.), és ugyanott azt is, hogy a gyermekgyógyászati ELLÁTÁS a kórház szabályzata alapján kiterjedhet a 16-18 évesekre. A forrás tehát nem mondja ki külön, hogy a pulzus- és légzésszám-TÁBLÁZAT hol ér véget; mi azt az értelmezést alkalmazzuk, hogy a táblázat az irányelvek része, ezért rá is a 16 éves határ vonatkozik. Az ellenérv, hogy a tábla 18 éves sort is tartalmaz — ezt viszont a hivatkozott Fleming-vizsgálat adathatára magyarázza („from birth to 18 years of age”). A döntés melletti gyakorlati érv: a 18-as határral ugyanaz a mért érték 17 és 18 évesen két kategóriányit eltérő szintet adott (a pulzusértékek 78%-ánál), és klinikailag tarthatatlan kimeneteket termelt (17 éves, tünetmentes torokfájós, izolált 118-as pulzussal → MSTR 1, reszuszitáció). A gyermek-táblázat eredménye ezért nem vész el, csak figyelmeztetéssé válik."
    },
    {
      "param": "hr",
      "group": "hemodynamic",
  ...
  "inputFields": [
    ...
    },
    {
      "id": "kohogesJelleg",
      "type": "select",
      "label": "Köhögés jellege (csecsemő/kisgyermek)",
      "group": "secondary",
      "options": [
        {
          "value": "erosodo_kohoges_csecsemonel_elsapadassal",
          "label": "Csecsemőnél kb. 1 hete erősödő köhögés, köhögés közben elsápadás — gyanús szamárköhögés (MSTR 4)"
        },
        {
          "value": "elsapadas_keringesi_instabilitaskent",
          "label": "Az elsápadás keringési instabilitás jeleként értékelendő (MSTR 2)"
        },
        {
          "value": "cyanotikus_kohoges_alatt",
          "label": "Köhögés közben cyanotikus (MSTR 1)"
        }
      ],
      "csakPanaszok": [
        "kohoges-torokszukulet"
  ...
  "cases": [
    ...
    },
    {
      ...
      "inputs": {
        ...
        "gyermekKullem": "nembeteg",
        "nehezlegzesFok": "nincs",
        "kohogesJelleg": "erosodo_kohoges_csecsemonel_elsapadassal"
      },
      "expected_level": 4,
  ...
  "figyelmeztetoSzabalyok": [
    ...
    },
    {
      ...
      "szoveg": "16-18 ÉV: ennél a betegnél a FELNŐTT referenciaértékek szerint soroltunk. A forrás kimondja, hogy a gyermekgyógyászati irányelveket 16 éves korig alkalmazhatóra fejlesztették (jegyzet 191. o.) — de azt külön nem mondja ki, hogy a pulzus- és légzésszám-táblázat hol ér véget, sőt ugyanott azt is írja, hogy a gyermekgyógyászati ELLÁTÁS a kórház szabályzata szerint kiterjedhet a 16-18 évesekre. EZ TEHÁT A MI ÉRTELMEZÉSÜNK: a táblázatot az irányelvek részének tekintjük, ezért 16 éves kortól a felnőtt értékeket alkalmazzuk. A táblázat 18 éves sora a hivatkozott Fleming-vizsgálat adathatára, nem alkalmazási határ. A gyermek-specifikus MINŐSÉGI szabályok (PAT, gyermek-GCS, kompenzált sokk, stridor) változatlanul élnek. Ha a gyermek-táblázat súlyosabb szintet adna, azt külön kiírjuk — bizonytalanság esetén a forrás elve szerint FELFELÉ kell triázsolni (tankönyv 96. o.).",
      "source": [
        {
          "doc": "jegyzet",
          "page": 191
